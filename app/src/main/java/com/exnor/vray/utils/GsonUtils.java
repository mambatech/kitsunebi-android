...
public class GsonUtils {
    ...
    public static Gson getGson(final boolean serializeNulls) {
        return createGson(!serializeNulls);
    }
    ...
    public static String toJson(final Object object, final boolean includeNulls) {
        return includeNulls ? createGson(true).toJson(object) : createGson(false).toJson(object);
    }
    ...
    public static <T> T fromJson(final String json, final Class<T> type) {
        return createGson(true).fromJson(json, type);
    }
    ...
    public static <T> T fromJson(final Reader reader, final Class<T> type) {
        return createGson(true).fromJson(reader, type);
    }
